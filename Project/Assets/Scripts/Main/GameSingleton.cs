...
public class GameSingleton
{
	...
	public void Init ()
	{
		...
		_DialogueManager = Zelda._Common._ResourcesManager.GetAndInstantiatePrefab<DialogueManager> (ResourcesManager.EPrefabName.DialogueManager, null);
		_DialogueManager.setMessageDialog (_HUDManager.getMessageBox (), _HUDManager.getMessageText ());
	}
